    ...
    <Section crosses id="how-to-use">
        <div className='container'>
            ...
            <div className='relative'>
                ...
                <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border  lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2 rounded-3xl lg:rounded-full" />
                </div>
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                            <div className='py-12 px-4 xl:px-8'>
                                ...
                                <ul className='flex items-center justify-between'>
                                    {brainwaveServicesIcons.map((item,index)=>(
                                        <li
                                        key={index} className={` rounded-2xl flex items-center justify-center ${index === 2 ? 'w-[4rem] h-[4rem] bg-conic-gradient p-0.25  md:w-[4.5rem] md:h-[4.5rem' : 'flex w-10 h-10 bg-n-6  md:w-15 md:h-15'}`}>
                                            <div className={index===2 ? 'flex items-center justify-center w-full h-full bg-n-7 rounded-[1rem]' : ''}>
                                                <img src={item} alt="icons" width={24} height={24}/>
                                            </div>
                                        </li>
                                    ))}
                                </ul>
                            ...
                            <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>
                                <img src={service3} alt="wef" className='h-full w-full object-cover'
                                width={520}
                                height={400} />
                                <VideoChatMessage />
                                <VideoBar/>
