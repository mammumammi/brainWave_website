...
const Hero = () => {
  return (
    ...
    crosses
    crossesOffset="lg:translate-7-[5.25rem]"
    customPaddings
    id='hero'
    >
        <div className="container relative">
            <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
                <h1 className="h1 mb-6">Explore The Possibilities of AI Chatting with {" "}  
                    <span className="inline-block relative"> BrainWave{" "} <img src={curve} className="absolute top-full left-0 w-full xl:" alt="curve" width={624} height={28}/></span>
                </h1>
            ...
            <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
                <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
                    <div className="bg-n-8 relative rounded-[1rem]">
                        ...
                        <div className="aspect-[33/40] rounded-b-[o.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
